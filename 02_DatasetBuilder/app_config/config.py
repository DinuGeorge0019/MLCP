...
class Config(object):
    ...
    def __init__(self, WORKING_DIR):
        ...
        self.config = {
            ...
            "BASE_TESTING_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\02_Base_Datasets\\base_testing_dataset.csv",
            "BASE_VALIDATION_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\02_Base_Datasets\\base_validation_dataset.csv",
            ...
            ############################################################################################################
            "OUTSIDE_TOP_5_TRAINING_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\03_Task_Datasets\\PSG_PREDICTING_ALGO\\AMT5_train.csv",
            "OUTSIDE_TOP_5_TESTING_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\03_Task_Datasets\\PSG_PREDICTING_ALGO\\AMT5_test.csv",
            "OUTSIDE_TOP_5_VALIDATION_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\03_Task_Datasets\\PSG_PREDICTING_ALGO\\AMT5_validation.csv",
        
            "OUTSIDE_TOP_10_TRAINING_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\03_Task_Datasets\\PSG_PREDICTING_ALGO\\AMT10_train.csv",
            "OUTSIDE_TOP_10_TESTING_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\03_Task_Datasets\\PSG_PREDICTING_ALGO\\AMT10_test.csv",
            "OUTSIDE_TOP_10_VALIDATION_DATASET_PATH":f"{WORKING_DIR}\\01_TASK_DATASETS\\03_Task_Datasets\\PSG_PREDICTING_ALGO\\AMT10_validation.csv",
